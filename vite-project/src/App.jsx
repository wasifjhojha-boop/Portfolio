...
function NotFoundPage() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-[#050403]">
      <p className="font-headings text-[10px] tracking-[0.5em] text-[#c9a84c] uppercase mb-4">Lost at Sea</p>
      <h1 className="font-headings text-4xl md:text-6xl font-bold text-[#f5e6c8] uppercase mb-6">Page Not Found</h1>
      <a href="/" className="px-6 py-3 bg-gradient-to-r from-[#c9a84c] to-[#d4af37] text-[#050403] font-headings text-[10px] font-bold tracking-[0.2em] uppercase">
        Return Home
      </a>
    </section>
  )
...
function App() {
  ...
  return (
    <div className="relative text-white w-full overflow-x-hidden font-body bg-[#050403]">
      {/* Global Navigation */}
      <Navbar />
