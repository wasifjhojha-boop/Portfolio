...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative w-full py-24 bg-(--background) overflow-hidden border-t border-(--accent)/10 ambient-ocean">
      {/* Decorative texture */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <motion.div
          ...
          className="relative max-w-5xl mx-auto overflow-hidden rounded-2xl bg-[#f6efdf] ring-1 ring-(--accent)/30 shadow-[0_30px_90px_-30px_rgba(0,0,0,0.85)]"
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 md:p-12 lg:border-r border-(--accent)/20">
              {/* Monogram */}
              <div className="w-12 h-12 rounded-full border border-(--accent) flex items-center justify-center mb-7">
                <span style={{ fontFamily: "'Cormorant Garamond', serif" }} className="text-(--accent) text-2xl font-semibold">W</span>
              </div>
              ...
              {/* Contact rows */}
              <div className="space-y-3.5 border-t border-(--accent)/25 pt-6">
                {CHANNELS.map((channel) => {
                  ...
                  return (
                    ...
                    >
                      <span className="w-8 h-8 rounded-full border border-(--accent)/40 flex items-center justify-center text-(--accent) shrink-0 group-hover:bg-(--accent) group-hover:text-[#f6efdf] transition-colors duration-300">
                        <Icon size={12} />
                      </span>
                      {!channel.iconOnly && (
                        <span
                          style={{ fontFamily: "'Jost', sans-serif" }}
                          className="text-[#3f3a2e] text-sm tracking-wide break-all group-hover:text-(--accent) transition-colors duration-300"
                        >
                          {channel.value}
                        </span>
                      )}
              ...
              <div className="mt-8 pt-4 border-t border-(--accent)/20 flex items-center justify-between">
            ...
            <div className="p-8 md:p-12 border-t lg:border-t-0 border-(--accent)/20">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {[
                    ...
                    <div key={f.id} className="flex flex-col">
                      ...
                      <input
                        ...
                        style={{ fontFamily: "'Jost', sans-serif" }}
                        className="px-4 py-3 rounded-sm border border-(--accent)/25 bg-[#efe5cf] text-sm text-[#3f3a2e] placeholder-[#9a8f74]/70 focus:outline-none focus:border-(--accent) focus:bg-[#f3ead6] transition-all duration-300"
                      />
                    </div>
                  ))}
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <textarea
                    ...
                    style={{ fontFamily: "'Jost', sans-serif" }}
                    className="px-4 py-3 rounded-sm border border-(--accent)/25 bg-[#efe5cf] text-sm text-[#3f3a2e] placeholder-[#9a8f74]/70 focus:outline-none focus:border-(--accent) focus:bg-[#f3ead6] transition-all duration-300 resize-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  style={{ fontFamily: "'Jost', sans-serif" }}
                  className="w-full py-3.5 rounded-sm font-semibold text-xs tracking-[0.25em] uppercase transition-all duration-300 flex items-center justify-center gap-3 bg-(--accent) text-[#f6efdf] hover:bg-[#8c6a28] hover:-translate-y-0.5 shadow-[0_8px_20px_-8px_rgba(160,125,51,0.6)]"
                >
